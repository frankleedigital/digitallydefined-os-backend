// prompts/hermesSystemPrompt.ts
// Unified Hermes system prompt — shared by every AI component/pipeline.
// Ported from prompts/hermesSystemPrompt.js / _shared/hermesSystemPrompt.ts
// so that /ai/ is fully self-contained (no dependency on _shared).
